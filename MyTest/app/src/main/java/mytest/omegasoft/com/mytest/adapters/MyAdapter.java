package mytest.omegasoft.com.mytest.adapters;
...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.ViewHolder> {
    ...
    public MyAdapter(ArrayList<History> myDataset) {
        mDataset = myDataset;
    }
...
//                .inflate(R.layout.history_list_row, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        History history = mDataset.get(position);
        if (history != null) {
            holder.mTextView.setText(history.getId() + " | " +
                    history.getType() + " | " +
                    history.getWorkout() + " | " +
                    history.getRest() + " | " +
                    history.getRounds() + " | " +
